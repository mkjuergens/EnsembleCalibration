""" 
Final experiments for Type 1 and Type 2 error analysis in function of alpha
...
def main_final_t1t2():
    ...
    results_df.to_csv("./final_results_experiments_t1t2_alpha_cobyla_big.csv", index=False)
