"""Setup-script for uncertaintyestimation package."""
import os
import sys
import importlib
...
PACKAGE_NAME = 'uncertaintyestimation'  # name used by PIP
IMPORT_NAME = 'uncertaintyestimation'  # name used for imports
NAMESPACE = ""
...
URLS = {
    'GITLAB': 'https://gitlab.cc-asp.fraunhofer.de/iee_oe224/UncertaintyEstimation',  # TODO add link for this to coookiecutter props?
