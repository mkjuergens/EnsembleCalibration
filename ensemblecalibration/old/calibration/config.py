...
from ensemblecalibration.calibration.cal_test_new import (
    _npbe_test_new_alpha,
    _npbe_test_v3_alpha,
    _npbe_test_mlp_new_alpha,
)
...
config_new_mlp_binary = {
    ...
    "SKCEul": {
        ...
        "params": {
            ...
            "obj": skce_ul_obj_new,
            "loss": SKCELoss(
                bw=0.01, dist_fct=tv_distance_tensor, tensor_miscal=skce_ul_tensor
            ),
            "n_epochs": 200,
            "lr": 0.0001,
            "patience": 20,
...
settings_2 = (
    {"N": [100], "M": [10], "K": [3], "R": [100], "u": [0.01], "alpha": [0.05]},
)
